...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>/dwr/util.js"></script>
  	...
  	<script type="text/javascript">
  		function custadd(){
  			var formMap = DWRUtil.getValues("custaddform");
  			custajax.saveCust(formMap,result);
  			custaddform.reset();
  ...
  <body> 
		 <h1 align="center" style="font-family:华文彩云;"> 客户信息添加</h1>
			<form name="custaddform" action="custinfoadd.action" method="post">
			      ...
			      <p align="center">
			      <input type="button" onclick="custadd()" value="提交">
